...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - Burglin\' Gnomes Wiki',
    description: 'Copyright and intellectual property information for Burglin\' Gnomes Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    keywords: [
      'copyright notice',
      'Burglin\' Gnomes Wiki copyright',
      'DMCA policy',
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - Burglin\' Gnomes Wiki',
      description: 'Copyright and intellectual property information for Burglin\' Gnomes Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2025-2026 Burglin\' Gnomes Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of Burglin\' Gnomes Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              Burglin\' Gnomes Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Steam</strong> - Owner of the Steam platform</li>
              <li><strong>Burglin' Gnomes Developers</strong> - Creators of the Burglin' Gnomes game</li>
            </ul>
            <p>
            ...
            <ul>
              ...
              <li><strong>Burglin' Gnomes</strong> - Trademark of the game developers</li>
              <li><strong>Burglin\' Gnomes Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
              ...
              affiliation with Burglin\' Gnomes Wiki.
            </p>
            ...
            <p>
              ...
              Burglin\' Gnomes Wiki<br />
              Email: <a href="mailto:dmca@burglingnomes.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@burglingnomes.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "Burglin\' Gnomes Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: Burglin\' Gnomes Wiki (burglingnomes.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@burglingnomes.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@burglingnomes.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@burglingnomes.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@burglingnomes.wiki</a>
            </p>
            <p>
